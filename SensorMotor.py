...
firebase_ref = db.reference("SensoresMotor")
...
commands = {
    ...
    "Avance encendido":obd.commands.TIMING_ADVANCE,
    "Flujo aire masivo":obd.commands.MAF,
    "Valvula admision":obd.commands.THROTTLE_POS,
    "Temperatura refrigerante": obd.commands.COOLANT_TEMP,
    "Presión colector admisión": obd.commands.INTAKE_PRESSURE,
    "Temperatura aceite": obd.commands.OIL_TEMP,
    "Consumo instantáneo combustible": obd.commands.FUEL_RATE,
